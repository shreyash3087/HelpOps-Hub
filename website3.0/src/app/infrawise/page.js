...
function Page() {
  ...
  const filteredExperts = experts.filter((expert) => {
    ...
    const matchesSkill =
      selectedSkill === "All" ||
      expert.skills.some((skill) => skill.includes(selectedSkill));
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-500 via-teal-400 to-white">
      {/* Hero Section */}
      <section className="px-6 py-20 text-center text-white relative overflow-hidden">
        <div className="max-w-4xl mx-auto relative z-10">
          <h1 className="text-5xl font-bold mb-6">
            Find Your DevOps Expert – Solve Problems Faster
          </h1>
          <p className="text-xl mb-8 opacity-90">
            Connect with skilled professionals to streamline your DevOps tasks
            effortlessly
          </p>
          <button
            onClick={() =>
          ...
          <div className="bg-white rounded-xl p-6 max-w-md w-full">
            ...
            <div className="border-t border-b py-4 mb-6">
              ...
              <p className="text-sm text-gray-600">
                After payment, you'll receive a Google Meet link for your
                session
              </p>
            </div>
      ...
      <footer className="bg-gray-900 text-white px-6 py-12">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-sm text-gray-500">
            © 2024 helpops. All payments are secure and processed by trusted
            payment partners.
          </p>
        </div>
      </footer>
